...
const LoginPage = () => {
  ...
  useEffect(() => {
    const fetchMasterData = async () => {
      const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxboOXEjGSjVEqfoYlk2gSkB-7lX90GhrcRwxMVLkcVbNLSovnNewFgVRTe18GtxZSg/exec"

      try {
        setIsDataLoading(true)

        // Get the spreadsheet ID from your Apps Script
        const SPREADSHEET_ID = "1yXC3tzwOpo4mhbBbOrVNHO8c3Z8ExPDxdIizsrJUrrM"
      ...
      <div className="w-full max-w-md shadow-lg border border-blue-200 rounded-lg bg-white">
        <div className="space-y-1 p-4 bg-gradient-to-r from-blue-100 to-purple-100 rounded-t-lg">
          <div className="flex items-center justify-center mb-2">
            ...
            <h2 className="text-2xl font-bold text-blue-700">Task Management Sheet</h2>
          </div>
